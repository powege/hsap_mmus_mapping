...
out.table <- "~/Dropbox/PhD/Data/Thesis_workflow/Results/Human_mouse_mapping/Manuscript/Figures_and_tables/s_table_7_hsap_v_mmus_RegBuild_v101_SNV_alignment_mendelian_total_zscores.csv"

...
out.figure <- "Figure_2_hsap_v_mmus_RegBuild_v101_ClinVar_Pathogenic_GWAS_SNV_alignment.pdf"
...
cv_plot <- cv[!annotation %in% c("Functional - all", "Functional - nonCDS", "NonCDS", "Total")]
cv_plot$x_lab <- paste0(cv_plot$annotation, "\n(n=", cv_plot$n_total, ")")
gwas_plot <- gwas[!annotation %in% c("Functional - all", "Functional - nonCDS", "NonCDS", "Total")]

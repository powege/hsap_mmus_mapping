...
out.multicell.figure <- "Figure_1_hsap_grch38_v_mmus_grcm38_v101_multicell_feature_alignment_stacked.pdf"
out.plot.table <- "Figure_1_hsap_grch38_v_mmus_grcm38_v101_multicell_feature_alignment_stacked.csv"
...
multi$percentage_aligned <- (multi$n_aligned / multi$n_total)*100
multi$percentage_conserved <- (multi$n_conserved / multi$n_total)*100
...
multi_plot <- multi[!annotation %in% c("Functional - all", "Functional - nonCDS", "NonCDS", "Total")]
